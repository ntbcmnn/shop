...
import {ProductFilt} from "@/stores/products/productStore";
...
export default function ProductCardCatalog({ product }: ProductCardProps) {
    ...
    return (
        <div  onClick={handleClick} className="relative max-w-xs rounded-lg border border-gray-300 shadow-lg bg-white overflow-hidden">
            {product.discount > 0 && (
